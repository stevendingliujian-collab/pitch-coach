...
async def get_rehearsal_report(
    ...
    return RehearsalReportResponse(
        ...
        originality_score=dims.get("originality"),
        compliance_score=dims.get("compliance"),
        pause_score=dims.get("pauses"),
        ...
        originality_overlap_ratio=dims.get("originality_overlap_ratio"),
        compliance_violations=dims.get("compliance_violations") or [],
        long_pause_count=dims.get("long_pause_count"),
